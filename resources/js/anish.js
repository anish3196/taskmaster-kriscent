...
!(function (n) {
                                    ...
                                    .each(function (t, e) {
                                        ...
                                        a || W(h, 0, "Incorrect column count", 18),
                                            a.mData === t &&
                                                ...
                                                (null === n && null === e) ||
                                                    ((a.mData = { _: t + ".display", sort: null !== n ? t + ".@data-" + n : N, type: null !== n ? t + ".@data-" + n : N, filter: null !== e ? t + ".@data-" + e : N }),
                                                    (a._isArrayHost = !0),
                                                    at(h, t)));
                                    }));
                        var S = h.oFeatures,
    ...
    function nt(t, e) {
        var n = w.defaults.column,
            ...
            n = P.extend({}, w.models.oColumn, n, { nTh: e || y.createElement("th"), sTitle: n.sTitle || (e ? e.innerHTML : ""), aDataSort: n.aDataSort || [a], mData: n.mData || a, idx: a }),
    ...
    function I(t) {
        ...
        for (Array.isArray(f) && e(f), d && f.pre && e(f.pre), e(t.aaSorting), d && f.post && e(f.post), n = 0; n < h.length; n++)
            for (r = (o = c[(s = h[n][(a = 0)])].aDataSort).length; a < r; a++)
                (l = c[(i = o[a])].sType || "string"), h[n]._idx === N && (h[n]._idx = P.inArray(h[n][1], c[i].asSorting)), u.push({ src: s, col: i, dir: h[n][1], index: h[n]._idx, type: l, formatter: w.ext.type.order[l + "-pre"] });
        return u;
    }
    function ie(t) {
        var e,
